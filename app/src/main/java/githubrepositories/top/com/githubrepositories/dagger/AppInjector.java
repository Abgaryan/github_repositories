...
public class AppInjector {
    ...
    public static void init(GithubRepositoriesApp githubRepositoriesApp) {
        DaggerAppComponent.builder().application(githubRepositoriesApp)
                .build().inject(githubRepositoriesApp);
